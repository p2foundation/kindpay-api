...
export class MobilemoneyService {
  ...
  constructor(
    ...
    private defualtUtility: DefaultUtilityService) {}
  ...
  sendMobileMoney(
    ...
    const rm2Params = {
      ...
      amount: amount || '',
      trxn: this.defualtUtility.generateTransactionId() || '',
    };
    ...
    return this.httpService
      ...
      .pipe(
        ...
        catchError((Sm2Error) => {
          this.logger.error(`ERROR CREDIT WALLET => ${Sm2Error.data}`);
  ...
  receiveMobileMoney(
    ...
    return this.httpService
      ...
      .pipe(
        ...
        catchError((rm2Error) => {
          this.logger.error(`ERROR DEBIT WALLET => ${rm2Error.data}`);
          return rm2Error.data;
        }),
      );
  }
}
